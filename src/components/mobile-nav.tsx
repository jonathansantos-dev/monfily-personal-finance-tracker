...
export function MobileNav({ displayName, avatarUrl }: MobileNavProps) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`md:hidden fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transform transition-transform duration-200 ease-in-out ${
